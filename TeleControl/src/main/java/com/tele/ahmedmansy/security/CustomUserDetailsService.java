...
public class CustomUserDetailsService implements UserDetailsService{
	...
	public UserDetails loadUserByUsername(String phoneID)
		...
		if(user==null){
			...
			return new org.springframework.security.core.userdetails.User(user.getPhoneID(), user.getPassword(), 
	...
	private List<GrantedAuthority> getGrantedAuthorities(User user){
		...
		logger.info("UserProfile : {}", user.getType());
