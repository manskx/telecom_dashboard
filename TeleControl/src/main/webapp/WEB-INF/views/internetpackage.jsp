...
<c:if test="${activeiservice != null}">
															<div>
																<ul class="list-unstyled spaced">
																	...
																	<li>
																		<i class="ace-icon fa fa-caret-right blue"></i>Quota
																		<b class="red">${activeiservice.quota} / MB</b>
																	</li>
																	...
																	<li>
																		<i class="ace-icon fa fa-caret-right blue"></i>
																			Duration
																		<b class="red">${activeiservice.duration} Days</b>
																	</li>
																	<div>
														<a href="<c:url value='/userdashboard/internetpackage-unsubscribe-${CurrentSubscribtion.id}' />" class="btn btn-block btn-sm btn-danger">
										...
										<div class="pricing-span">
											<div class="widget-box pricing-box-small  widget-color-orange">
												...
												<div class="widget-body">
													...
													<div>
														<a href="<c:url value='/userdashboard/internetpackage-subscribe-${iservice.id}' />" class="btn btn-block btn-sm btn-warning">
															<span>Subscribe</span>
														</a>
													</div>
												</div>
